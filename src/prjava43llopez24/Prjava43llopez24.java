...
public class Prjava43llopez24 extends Frame 
   ...
   public Prjava43llopez24 () { 
      ...
      setTitle("nova finestra prjava43llopez24");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43llopez24();  // Let the construct do the job 
   } 
